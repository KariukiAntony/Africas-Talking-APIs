""" Here we are going to send an sms using an alphanumeric """
""" while using this alphanumeric/sender id, a customer cannot reply to this code"""
""" make sure you have a registered alphanumeric """
...
def send_sms(message: str, phone_number: str):
    ...
    data = urlencode({
        ...
        "to": phone_number,
        "message":message,
        "from": os.environ.get("alphanumeric")
    })
...
def handle_send_function():
    ...
    send_sms(message=message, phone_number=phone_number) # invoke the sending function
